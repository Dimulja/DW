...
public class Sqlite3Parser  {
	...
	Statement stmt =null;
	    try {
	      ...
	      String sql="Select z.datum, z.Uhrzeit, s.Autobahn, s.Richtung_Start, s.Richtung_Ende,"
	      		+ " s.Streckenabschnitt_Start, s.Streckenabschnitt_Ende, "
	      		 + "d.Art, d.Laenge from Zeitpunkt z JOIN Stau s on s.Zeitpunkt=z.id "
	      		 + "JOIN Daten d on d.id =s.Daten";
